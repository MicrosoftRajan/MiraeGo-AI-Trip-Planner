...
export const useThemeToggle = ({
  ...
  }, [theme, setPreference, runThemeTransition, isDark]);

  const setCrazyLightTheme = useCallback(() => {
    setIsDark(false);
    runThemeTransition(() => setPreference("light"));
  }, [setPreference, runThemeTransition]);

  const setCrazyDarkTheme = useCallback(() => {
    setIsDark(true);
    runThemeTransition(() => setPreference("dark"));
  }, [setPreference, runThemeTransition]);
  ...
  const setCrazySystemTheme = useCallback(() => {
    ...
    runThemeTransition(() => setPreference("system"));
  }, [setPreference, runThemeTransition]);
